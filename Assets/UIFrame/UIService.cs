...
namespace Wargon.UI {
    public class UIService : IUIService {
        ...
        private static IUIService instance;
        public static IUIService Instance {
            get {
                if (instance is null) {
                    instance = UIService.Create();
                }
                return instance;
            }
        }
        public static UIService Create() {
            var obj = Resources.Load<UIRoot>("Canvas");
            var isntance = Object.Instantiate(obj);
            return new UIService(isntance);
        }
        ...
        public UIService(UIRoot uiRoot) {
            ...
            instance = this;
            _dependencyContainer = DI.Injector.GetOrCreate();
            Application.quitting += Clear;
        }
