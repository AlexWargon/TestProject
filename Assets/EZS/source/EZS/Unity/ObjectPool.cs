...
//
//         public static Vector3 UnActivePos = new(-100000f, -100000f, 0);
//         private static ObjectPool instance;
//         private readonly Dictionary<int, Queue<Entity>> entityPool = new();
//         private readonly List<PoolContainer> poolContainers = new();
...
//         private int instatiatePerFrameCounter;
//
...
//                 var command = new PoolCommand.Command
//                 {
//                     entity = e, prefab = poolKey, pos = position, rotation = rotation,
//                     CommandType = PoolCommand.CommandType.Pool
//                 };
...
//
//                 var poolHolder =
//                     new PoolContainer(new GameObject(), poolSize, prefab.name, poolKey, poolContainers.Count)
//                     {
...
//             {
//                 Object.Destroy(poolContainers[entityPool[poolKey].Dequeue().Get<Pooled>().containerIndex].transform
//                     .gameObject);
...
//         private static readonly Vector2 UnActivePosition = new(-100000, -100000);
//
//         [MethodImpl(MethodImplOptions.AggressiveInlining)]
...
//             else if (Mode == PoolObjectMode.GameObject) mono.SetActive(IsActive);
//         }
//
//         [MethodImpl(MethodImplOptions.AggressiveInlining)]
